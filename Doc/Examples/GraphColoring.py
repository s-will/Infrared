...
# +
optimal_assignment = solver.optimize()

colors=["red","cyan","blue","orange"]

coloring = {i:colors[v] for i,v in enumerate(optimal_assignment.values())}
del coloring[0]
